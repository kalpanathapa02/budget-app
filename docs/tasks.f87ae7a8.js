var e,t,n,s,o,i,a,r,l,c,d,u,h,f,g,m,E,p,C,y,O,v,_,I,T,w=globalThis,N={},R={},A=w.parcelRequire94c2;null==A&&((A=function(e){if(e in N)return N[e].exports;if(e in R){var t=R[e];delete R[e];var n={id:e,exports:{}};return N[e]=n,t.call(n.exports,n,n.exports),n.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){R[e]=t},w.parcelRequire94c2=A),A.register;var S=A("47Mwn"),b=A("ilpIi");A("6AR8M"),(e=h||(h={})).STRING="string",e.NUMBER="number",e.INTEGER="integer",e.BOOLEAN="boolean",e.ARRAY="array",e.OBJECT="object",(t=f||(f={})).LANGUAGE_UNSPECIFIED="language_unspecified",t.PYTHON="python",(n=g||(g={})).OUTCOME_UNSPECIFIED="outcome_unspecified",n.OUTCOME_OK="outcome_ok",n.OUTCOME_FAILED="outcome_failed",n.OUTCOME_DEADLINE_EXCEEDED="outcome_deadline_exceeded";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $(e){return e.text=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(e.candidates[0]))throw new L(`${q(e)}`,e);return function(e){var t,n,s,o;let i=[];if(null===(n=null===(t=e.candidates)||void 0===t?void 0:t[0].content)||void 0===n?void 0:n.parts)for(let t of null===(o=null===(s=e.candidates)||void 0===s?void 0:s[0].content)||void 0===o?void 0:o.parts)t.text&&i.push(t.text),t.executableCode&&i.push("\n```"+t.executableCode.language+"\n"+t.executableCode.code+"\n```\n"),t.codeExecutionResult&&i.push("\n```\n"+t.codeExecutionResult.output+"\n```\n");return i.length>0?i.join(""):""}(e)}if(e.promptFeedback)throw new L(`Text not available. ${q(e)}`,e);return""},e.functionCall=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(e.candidates[0]))throw new L(`${q(e)}`,e);return console.warn("response.functionCall() is deprecated. Use response.functionCalls() instead."),j(e)[0]}if(e.promptFeedback)throw new L(`Function call not available. ${q(e)}`,e)},e.functionCalls=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(e.candidates[0]))throw new L(`${q(e)}`,e);return j(e)}if(e.promptFeedback)throw new L(`Function call not available. ${q(e)}`,e)},e}function j(e){var t,n,s,o;let i=[];if(null===(n=null===(t=e.candidates)||void 0===t?void 0:t[0].content)||void 0===n?void 0:n.parts)for(let t of null===(o=null===(s=e.candidates)||void 0===s?void 0:s[0].content)||void 0===o?void 0:o.parts)t.functionCall&&i.push(t.functionCall);return i.length>0?i:void 0}const K=[y.RECITATION,y.SAFETY,y.LANGUAGE];function Y(e){return!!e.finishReason&&K.includes(e.finishReason)}function q(e){var t,n,s;let o="";if((!e.candidates||0===e.candidates.length)&&e.promptFeedback)o+="Response was blocked",(null===(t=e.promptFeedback)||void 0===t?void 0:t.blockReason)&&(o+=` due to ${e.promptFeedback.blockReason}`),(null===(n=e.promptFeedback)||void 0===n?void 0:n.blockReasonMessage)&&(o+=`: ${e.promptFeedback.blockReasonMessage}`);else if(null===(s=e.candidates)||void 0===s?void 0:s[0]){let t=e.candidates[0];Y(t)&&(o+=`Candidate was blocked due to ${t.finishReason}`,t.finishMessage&&(o+=`: ${t.finishMessage}`))}return o}function J(e){return this instanceof J?(this.v=e,this):new J(e)}"function"==typeof SuppressedError&&SuppressedError;/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ei(e,t,n,s){return(await F(t,I.COUNT_TOKENS,e,!1,JSON.stringify(n),s)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ea(e,t,n,s){return(await F(t,I.EMBED_CONTENT,e,!1,JSON.stringify(n),s)).json()}async function er(e,t,n,s){let o=n.requests.map(e=>Object.assign(Object.assign({},e),{model:t}));return(await F(t,I.BATCH_EMBED_CONTENTS,e,!1,JSON.stringify({requests:o}),s)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ec{constructor(e){this.apiKey=e}getGenerativeModel(e,t){if(!e.model)throw new x("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new el(this.apiKey,e,t)}getGenerativeModelFromCachedContent(e,t,n){if(!e.name)throw new k("Cached content must contain a `name` field.");if(!e.model)throw new k("Cached content must contain a `model` field.");for(let n of["model","systemInstruction"])if((null==t?void 0:t[n])&&e[n]&&(null==t?void 0:t[n])!==e[n]){if("model"===n&&(t.model.startsWith("models/")?t.model.replace("models/",""):t.model)===(e.model.startsWith("models/")?e.model.replace("models/",""):e.model))continue;throw new k(`Different value for "${n}" specified in modelParams (${t[n]}) and cachedContent (${e[n]})`)}let s=Object.assign(Object.assign({},t),{model:e.model,tools:e.tools,toolConfig:e.toolConfig,systemInstruction:e.systemInstruction,cachedContent:e});return new el(this.apiKey,s,n)}}const ed=document.getElementById("taskInput"),eu=document.getElementById("addTaskBtn"),eh=document.getElementById("taskList"),ef=document.getElementById("send-btn"),eg=document.getElementById("chat-input"),em=document.getElementById("chat-history"),eE=document.getElementById("signOutBttn"),ep=JSON.parse(localStorage.getItem("email"));async function eC(){T=new ec((await (0,b.getDoc)((0,b.doc)(S.db,"apikey","googlegenai"))).data().key).getGenerativeModel({model:"gemini-1.5-flash"})}function ey(e){let t=document.createElement("div");t.textContent=e,t.className="history",em.appendChild(t),eg.value=""}async function eO(e){ey((await T.generateContent(e)).response.text())}async function ev(e){let t=await ew(e);ed.value="",eR(t,e)}async function e_(e){await (0,b.updateDoc)((0,b.doc)(S.db,"todos",e),{completed:!0})}function eI(e){document.getElementById(e).remove()}async function eT(){var e=await eN();eh.innerHTML="";let t=[];e.forEach(e=>{t.push({id:e.id,text:e.data().text,completed:e.data().completed})}),t.sort(function(e,t){return new Date(t.timeCreated)-new Date(e.timeCreated)}),t.forEach(e=>{e.completed||eR(e.id,e.text)})}async function ew(e){return(await (0,b.addDoc)((0,b.collection)(S.db,"todos"),{text:e,email:ep,completed:!1})).id}async function eN(){let e=(0,b.query)((0,b.collection)(S.db,"todos"),(0,b.where)("email","==",ep));return await (0,b.getDocs)(e)}function eR(e,t){let n=document.createElement("li");n.id=e,n.textContent=t,n.tabIndex=0,n.setAttribute("name",t.toLowerCase()),eh.appendChild(n)}ep||(window.location.href="index.html"),window.addEventListener("load",async()=>{eC(),eT()}),ef.addEventListener("click",async()=>{let e=eg.value.trim().toLowerCase();e?!function(e){if(e.startsWith("add task")){let t=e.replace("add task","").trim();return t?(ev(t),ey("Task "+t+" added!")):ey("Please specify a task to add."),!0}if(e.startsWith("complete")){let t,n=e.replace("complete","").trim();return n?0!=(t=document.getElementsByName(n)).length&&(t.forEach(e=>{e_(e.id),eI(e.id)}),1)?ey("Task "+n+" marked as complete."):ey("Task not found!"):ey("Please specify a task to complete."),!0}return!1}(e)&&eO(e):ey("Please enter a prompt")}),eg.addEventListener("keypress",function(e){"Enter"===e.key&&ef.click()}),eu.addEventListener("click",async()=>{let e=ed.value.trim();e?await ev(e):alert("Please enter a task!")}),eh.addEventListener("click",async e=>{"LI"===e.target.tagName&&(e_(e.target.id),eI(e.target.id))}),ed.addEventListener("keypress",function(e){"Enter"===e.key&&eu.click()}),eh.addEventListener("keypress",async function(e){"LI"===e.target.tagName&&"Enter"===e.key&&(e_(e.target.id),eI(e.target.id))}),window.addEventListener("error",function(e){console.error("Error occurred: ",e.message)}),window.addEventListener("beforeunload",function(e){localStorage.removeItem("email")}),eE.addEventListener("click",function(e){localStorage.removeItem("email"),window.location.href="index.html"});
//# sourceMappingURL=tasks.f87ae7a8.js.map
