var t,e,n,s,o,i,a,r,l,c,d,u,h,f,g,m,E,p,C,y,O,v,_,I,T,N=globalThis,S={},A={},R=N.parcelRequire94c2;null==R&&((R=function(t){if(t in S)return S[t].exports;if(t in A){var e=A[t];delete A[t];var n={id:t,exports:{}};return S[t]=n,e.call(n.exports,n,n.exports),n.exports}var s=Error("Cannot find module '"+t+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(t,e){A[t]=e},N.parcelRequire94c2=R),R.register;var w=R("47Mwn"),b=R("ilpIi");(t=h||(h={})).STRING="string",t.NUMBER="number",t.INTEGER="integer",t.BOOLEAN="boolean",t.ARRAY="array",t.OBJECT="object",(e=f||(f={})).LANGUAGE_UNSPECIFIED="language_unspecified",e.PYTHON="python",(n=g||(g={})).OUTCOME_UNSPECIFIED="outcome_unspecified",n.OUTCOME_OK="outcome_ok",n.OUTCOME_FAILED="outcome_failed",n.OUTCOME_DEADLINE_EXCEEDED="outcome_deadline_exceeded";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class x extends Error{constructor(t){super(`[GoogleGenerativeAI Error]: ${t}`)}}class D extends x{constructor(t,e){super(t),this.response=e}}class L extends x{constructor(t,e,n,s){super(t),this.status=e,this.statusText=n,this.errorDetails=s}}class U extends x{}(u=I||(I={})).GENERATE_CONTENT="generateContent",u.STREAM_GENERATE_CONTENT="streamGenerateContent",u.COUNT_TOKENS="countTokens",u.EMBED_CONTENT="embedContent",u.BATCH_EMBED_CONTENTS="batchEmbedContents";class F{constructor(t,e,n,s,o){this.model=t,this.task=e,this.apiKey=n,this.stream=s,this.requestOptions=o}toString(){var t,e;let n=(null===(t=this.requestOptions)||void 0===t?void 0:t.apiVersion)||"v1beta",s=(null===(e=this.requestOptions)||void 0===e?void 0:e.baseUrl)||"https://generativelanguage.googleapis.com",o=`${s}/${n}/${this.model}:${this.task}`;return this.stream&&(o+="?alt=sse"),o}}async function H(t){var e;let n=new Headers;n.append("Content-Type","application/json"),n.append("x-goog-api-client",function(t){let e=[];return(null==t?void 0:t.apiClient)&&e.push(t.apiClient),e.push("genai-js/0.21.0"),e.join(" ")}(t.requestOptions)),n.append("x-goog-api-key",t.apiKey);let s=null===(e=t.requestOptions)||void 0===e?void 0:e.customHeaders;if(s){if(!(s instanceof Headers))try{s=new Headers(s)}catch(t){throw new U(`unable to convert customHeaders value ${JSON.stringify(s)} to Headers: ${t.message}`)}for(let[t,e]of s.entries()){if("x-goog-api-key"===t)throw new U(`Cannot set reserved header name ${t}`);if("x-goog-api-client"===t)throw new U(`Header name ${t} can only be set using the apiClient field`);n.append(t,e)}}return n}async function B(t,e,n,s,o,i){let a=new F(t,e,n,s,i);return{url:a.toString(),fetchOptions:Object.assign(Object.assign({},function(t){let e={};if((null==t?void 0:t.signal)!==void 0||(null==t?void 0:t.timeout)>=0){let n=new AbortController;(null==t?void 0:t.timeout)>=0&&setTimeout(()=>n.abort(),t.timeout),(null==t?void 0:t.signal)&&t.signal.addEventListener("abort",()=>{n.abort()}),e.signal=n.signal}return e}(i)),{method:"POST",headers:await H(a),body:o})}}async function G(t,e,n,s,o,i={},a=fetch){let{url:r,fetchOptions:l}=await B(t,e,n,s,o,i);return P(r,l,a)}async function P(t,e,n=fetch){let s;try{s=await n(t,e)}catch(e){!function(t,e){let n=t;throw t instanceof L||t instanceof U||((n=new x(`Error fetching from ${e.toString()}: ${t.message}`)).stack=t.stack),n}(e,t)}return s.ok||await $(s,t),s}async function $(t,e){let n,s="";try{let e=await t.json();s=e.error.message,e.error.details&&(s+=` ${JSON.stringify(e.error.details)}`,n=e.error.details)}catch(t){}throw new L(`Error fetching from ${e.toString()}: [${t.status} ${t.statusText}] ${s}`,t.status,t.statusText,n)}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j(t){return t.text=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(t.candidates[0]))throw new D(`${q(t)}`,t);return function(t){var e,n,s,o;let i=[];if(null===(n=null===(e=t.candidates)||void 0===e?void 0:e[0].content)||void 0===n?void 0:n.parts)for(let e of null===(o=null===(s=t.candidates)||void 0===s?void 0:s[0].content)||void 0===o?void 0:o.parts)e.text&&i.push(e.text),e.executableCode&&i.push("\n```"+e.executableCode.language+"\n"+e.executableCode.code+"\n```\n"),e.codeExecutionResult&&i.push("\n```\n"+e.codeExecutionResult.output+"\n```\n");return i.length>0?i.join(""):""}(t)}if(t.promptFeedback)throw new D(`Text not available. ${q(t)}`,t);return""},t.functionCall=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(t.candidates[0]))throw new D(`${q(t)}`,t);return console.warn("response.functionCall() is deprecated. Use response.functionCalls() instead."),k(t)[0]}if(t.promptFeedback)throw new D(`Function call not available. ${q(t)}`,t)},t.functionCalls=()=>{if(t.candidates&&t.candidates.length>0){if(t.candidates.length>1&&console.warn(`This response had ${t.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),Y(t.candidates[0]))throw new D(`${q(t)}`,t);return k(t)}if(t.promptFeedback)throw new D(`Function call not available. ${q(t)}`,t)},t}function k(t){var e,n,s,o;let i=[];if(null===(n=null===(e=t.candidates)||void 0===e?void 0:e[0].content)||void 0===n?void 0:n.parts)for(let e of null===(o=null===(s=t.candidates)||void 0===s?void 0:s[0].content)||void 0===o?void 0:o.parts)e.functionCall&&i.push(e.functionCall);return i.length>0?i:void 0}const K=[y.RECITATION,y.SAFETY,y.LANGUAGE];function Y(t){return!!t.finishReason&&K.includes(t.finishReason)}function q(t){var e,n,s;let o="";if((!t.candidates||0===t.candidates.length)&&t.promptFeedback)o+="Response was blocked",(null===(e=t.promptFeedback)||void 0===e?void 0:e.blockReason)&&(o+=` due to ${t.promptFeedback.blockReason}`),(null===(n=t.promptFeedback)||void 0===n?void 0:n.blockReasonMessage)&&(o+=`: ${t.promptFeedback.blockReasonMessage}`);else if(null===(s=t.candidates)||void 0===s?void 0:s[0]){let e=t.candidates[0];Y(e)&&(o+=`Candidate was blocked due to ${e.finishReason}`,e.finishMessage&&(o+=`: ${e.finishMessage}`))}return o}function J(t){return this instanceof J?(this.v=t,this):new J(t)}"function"==typeof SuppressedError&&SuppressedError;/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ti(t,e,n,s){return(await G(e,I.COUNT_TOKENS,t,!1,JSON.stringify(n),s)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ta(t,e,n,s){return(await G(e,I.EMBED_CONTENT,t,!1,JSON.stringify(n),s)).json()}async function tr(t,e,n,s){let o=n.requests.map(t=>Object.assign(Object.assign({},t),{model:e}));return(await G(e,I.BATCH_EMBED_CONTENTS,t,!1,JSON.stringify({requests:o}),s)).json()}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tc{constructor(t){this.apiKey=t}getGenerativeModel(t,e){if(!t.model)throw new x("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new tl(this.apiKey,t,e)}getGenerativeModelFromCachedContent(t,e,n){if(!t.name)throw new U("Cached content must contain a `name` field.");if(!t.model)throw new U("Cached content must contain a `model` field.");for(let n of["model","systemInstruction"])if((null==e?void 0:e[n])&&t[n]&&(null==e?void 0:e[n])!==t[n]){if("model"===n&&(e.model.startsWith("models/")?e.model.replace("models/",""):e.model)===(t.model.startsWith("models/")?t.model.replace("models/",""):t.model))continue;throw new U(`Different value for "${n}" specified in modelParams (${e[n]}) and cachedContent (${t[n]})`)}let s=Object.assign(Object.assign({},e),{model:t.model,tools:t.tools,toolConfig:t.toolConfig,systemInstruction:t.systemInstruction,cachedContent:t});return new tl(this.apiKey,s,n)}}const td=document.getElementById("incomeInput"),tu=document.getElementById("addTransactionBtn"),th=document.getElementById("expenseList"),tf=document.getElementById("balance"),tg=document.getElementById("send-btn"),tm=document.getElementById("chat-input"),tE=document.getElementById("chat-history"),tp=document.getElementById("signOutBttn"),tC=JSON.parse(localStorage.getItem("email"));async function ty(){T=new tc("AIzaSyBGU3f-_SmCYjGmhLOydtF28FnKLe01fHs").getGenerativeModel({model:"gemini-1.5-flash"})}function tO(t){let e=document.createElement("div");e.textContent=t,e.className="history",tE.appendChild(e),tm.value=""}async function tv(t){tO((await T.generateContent(t)).response.text())}async function t_(){let t=parseFloat(td.value.trim()),e=document.getElementById("transactionType").value;if(!isNaN(t)&&t>0){let n,s=await tI(t,e);td.value="",tN(),(n=document.createElement("li")).id=s,n.textContent=`${e.charAt(0).toUpperCase()+e.slice(1)}: $${t.toFixed(2)}`,th.appendChild(n)}else alert("Please enter a valid amount!")}async function tI(t,e){return(await (0,b.addDoc)((0,b.collection)(w.db,"transactions"),{amount:t,type:e,email:tC})).id}async function tT(){let t=(0,b.query)((0,b.collection)(w.db,"transactions"),(0,b.where)("email","==",tC));return await (0,b.getDocs)(t)}async function tN(){let t=await tT(),e=0,n=0;t.forEach(t=>{"income"===t.data().type?e+=t.data().amount:"expense"===t.data().type&&(n+=t.data().amount)});let s=e-n;tf.textContent=`$${s.toFixed(2)}`}tC||(window.location.href="index.html"),window.addEventListener("load",async()=>{ty(),tN()}),tg.addEventListener("click",async()=>{let t=tm.value.trim();t?tv(t):tO("Please enter a prompt")}),tu.addEventListener("click",async()=>{await t_()}),tp.addEventListener("click",function(){localStorage.removeItem("email"),window.location.href="index.html"}),document.getElementById("chatbot-toggle").addEventListener("click",function(){document.getElementById("chatbot-container").style.display="block"}),document.getElementById("close-chat").addEventListener("click",function(){document.getElementById("chatbot-container").style.display="none"});
//# sourceMappingURL=my-budget.3e1c1a2b.js.map
